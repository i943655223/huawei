		window.onload = function(){
			...
			var small = document.getElementsByClassName('boximg')[0];//小盒子
			var mask = document.getElementsByClassName('mask')[0];//遮罩层
			var big = document.getElementsByClassName('bigimg')[0];//大盒子
			var bigImg = document.getElementsByClassName('bigImg')[0];//大盒子中的图片
			//1 鼠标移入small盒子,mask盒子和big盒子显示
			...
			small.onmousemove = function(e){
				...
				var x = pageX - small.offsetLeft - mask.offsetWidth*2-40;
				//为了让鼠标在mask中间,x要减去mask盒子的一半宽度
				var y = pageY - small.offsetTop - mask.offsetHeight-20;
